...
function cleanDictionaryDefinition(value: string) {
  const safeReplacements: Array<[RegExp, string]> = [
    ...
    [/\bauy\b/gi, "any"],
    [/\bthc\b/gi, "the"],
    [/\bdefiniltve\b/gi, "definitive"],
    [/\bdefinitlve\b/gi, "definitive"],
    [/\bdetinitive\b/gi, "definitive"],
    [/\bsigni-\s*fication\b/gi, "signification"],
    [/\btiling\b/gi, "thing"],
    [/\baccoun?ts\b/gi, "accounts"],
    ...
    [/\bhi\.s\b/gi, "his"],
    [/\bu[ji]\)on\b/gi, "upon"],
    [/\bev dence\b/gi, "evidence"],
    [/\breason\.!\b/gi, "reason"],
    [/\bminil\b/gi, "mind"],
    [/\bexi>ect\b/gi, "expect"],
    [/\bt trust\b/gi, "to trust"],
    [/\btl goodness\b/gi, "the goodness"],
    [/\bapi\)ears\b/gi, "appears"],
    [/\binijilied\b/gi, "implied"],
    [/\bpeniiission\b/gi, "permission"],
    [/\bqualilies\b/gi, "qualities"],
    [/\bquali-\s*ties\b/gi, "qualities"],
    [/\bajie\b/gi, "ape"],
    [/\bser-\s*vile\b/gi, "servile"],
    [/\bmanmr\b/gi, "manner"],
    [/\blicnce\b/gi, "hence"],
    [/\baf-\s*li'?ctcd\b/gi, "affected"],
    [/\btrilling\b/gi, "trifling"],
    [/\binsigniticant\b/gi, "insignificant"],
    [/\bJt\b/g, "It"],
    [/\bOod\b/g, "God"],
    [/\bG od\b/g, "God"],
    [/\bL ord\b/g, "Lord"],
