...
- 8 `Pulpit Commentary` archive volumes, cleaned into readable volume titles and labeled for OCR spot-check before quotation
- 8 `Preacher's Complete Homiletical Commentary` archive volumes for lesson outlines, applications, and sermon preparation
- 4 additional `Biblical Illustrator` archive volumes for verse-level homiletical helps and illustrations
- 4 KJV / English Bible and word-study helps:
  - `Authorized Version 1611 Facsimile`
  - `The Newberry Bible: Authorized Version Study Edition`
  - `Young's Analytical Concordance to the Bible`
  - `The Englishman's Greek New Testament`
- 1 Spurgeon resource:
  - `The Sword and the Trowel - Spurgeon Magazine Volume`

One Archive.org source returned a server error during import and was replaced with a working reviewed source. The remaining verified public-domain queue now contains 233 staged resources for future waves.
...
Added 42 verified public commentary entries for Job 1-42:

- G. Campbell Morgan, Job 1-42

This strengthens Job for suffering, counsel, faith, worship, sovereignty, repentance, and pastoral teaching.
...
Added 90 verified public commentary entries for Psalms 66-95:

- Matthew Poole, Psalms 66-95
- The Pulpit Commentary, Psalms 66-95
- The Biblical Illustrator, Psalms 66-95

This continues the Psalms expansion for worship, thanksgiving, lament, temple praise, and messianic study while keeping the import split into reviewable public-domain batches.
...
Added 90 verified public commentary entries for Psalms 6-35:

- Matthew Poole, Psalms 6-35
- The Pulpit Commentary, Psalms 6-35
- The Biblical Illustrator, Psalms 6-35

This expands Psalms coverage in a controlled batch for devotional reading, prayer, preaching, worship, lament, and Sunday school preparation while keeping duplicate protection and source metadata intact.
