...
| Author | Source | Rights status | Chapters imported | Chapters remaining | Review status |
| --- | --- | --- | --- | --- | --- |
| H. A. Ironside | Exact editions and archive pages required for each work | Mixed by title/edition. Import only exact sources with verified U.S. public-domain or documented permission status. | 3 sample chapters already public | Identify additional Bible-book works and verify edition status before import. | Needs source-by-source review |
...
- Library expansion commentary batch: Matthew Henry Matthew and Mark promoted from staged Needs Review to public verified entries.
- Library expansion commentary batch: JFB John 6-21, Romans 9-16, and Luke 1-23 promoted from staged Needs Review to public verified entries.
- Library expansion commentary batch: Barnes and Adam Clarke Matthew, Mark, and Acts imported from reviewed StudyLight public-domain chapter pages.
