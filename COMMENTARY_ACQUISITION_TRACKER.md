...
| Albert Barnes | https://sacred-texts.com/bib/cmt/barnes/ | Public-domain original work by publication date and author death; source file/terms need full import review. | 1 sample: Romans 5 | Whole-Bible source acquisition, segmentation, and quality review remain. | Verified sample; full import needs review |
| Jamieson-Fausset-Brown | https://www.ccel.org/ccel/jamieson/jfb.html | Public-domain original work first published in 1871; CCEL source path available. | 1 sample: John 3 | Whole-Bible source acquisition, segmentation, and quality review remain. | Verified sample; full import needs review |
| John Wesley | https://www.ccel.org/w/wesley/notes/index.html | CCEL work record lists Wesley's Notes on the Bible as Public Domain. | 1 sample: John 3 | Full source handling and Methodist perspective notes remain. | Verified sample; full import needs review |
| John Gill | https://www.biblestudytools.com/commentaries/gills-exposition-of-the-bible/ | Source page states the exposition is public domain and may be freely used and distributed. | 1 sample: John 3 | Need stable source file, segmentation plan, and quality review. | Verified sample; full import needs review |
| Adam Clarke | https://onlinebooks.library.upenn.edu/webbin/book/lookupid?key=ha102300285 | Public-domain by publication date; Online Books Page lists an 1843 edition. | 1 sample: Romans 5 | Need clean text source, edition review, and warning labels. | Verified sample; full import needs review |
...
1. Finish validating the five Tier 1 sample entries in `data/imports/commentary-acquisition-phase-1-samples.json`.
2. Choose one Tier 1 collection for the next 10-25 chapter batch based on cleanest source file and easiest chapter segmentation.
3. Prefer JFB or Wesley next because CCEL has clear work pages and downloadable formats.
4. Keep Barnes, Gill, and Clarke in sample mode until a stable full-text source and import parser are selected.
