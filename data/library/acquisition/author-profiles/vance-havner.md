# Vance Havner Author Profile Stub
...
| Field | Value |
| --- | --- |
| Author / ministry | Vance Havner |
| Resource category | Devotional preaching and revival |
...
| --- | --- | --- | --- | --- | --- |
| TBD | Devotional preaching and revival | TBD | Unknown - verify | Needs Review | Add title-level review before import. |
...
> Modern copyrighted works likely require permission; strong preaching/devotional candidate.
