# Kregel Publications Acquisition Profile Stub
...
| Field | Value |
| --- | --- |
| Author / ministry | Kregel Publications |
| Resource category | Publisher: Bible study commentaries ministry resources and reprints |
| Profile status | Needs Review |
| Resource approval status | Needs Review |
| Copyright status | Unknown - verify |
| Permission needed | Yes |
| Permission/contact info | kregelbooks@kregel.com |
...
| --- | --- | --- | --- | --- | --- |
| TBD | Publisher: Bible study commentaries ministry resources and reprints | TBD | Unknown - verify | Needs Review | Add title-level review before import. |
...
| Field | Value |
| --- | --- |
| Known contact | kregelbooks@kregel.com |
| Website | https://www.kregel.com/ |
