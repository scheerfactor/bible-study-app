# Study Bible Rights Review

This file tracks Study Bible candidates before any notes are imported into the public Library or Commentary system.

## Henry M. Morris / Defender's Study Bible

- Work: *The Defender's Study Bible* / *The Henry Morris Study Bible*
- Author: Henry M. Morris
- Known publication evidence: 1995 first Defender's Study Bible edition; later Henry Morris Study Bible / Defender's Edition editions are modern.
- Current status: Permission Needed
- Public import decision: Do not import text publicly.
- Reason: The work is modern copyrighted material. Physical ownership, Internet Archive availability, or commercial product availability does not grant public digital distribution rights.
- Safe next step: Add a permission request record for ICR / publisher rights review before any public text, excerpt, commentary, TTS, audiobook, or paid-access use.

## C. I. Scofield / 1917 Scofield Reference Notes
...
1. Source only original 1917 notes from a public-domain source.
2. Preserve source URL and edition notes on every entry.
3. Split by book/chapter/verse where possible.
4. Stage all rows as Needs Review first.
5. Promote a small batch first:
   - Genesis 1-3
   - John 3
   - Romans 8
   - Daniel 7
