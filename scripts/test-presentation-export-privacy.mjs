...
const { exportSlideDeckPowerPoint: exportDeck, presentationExportOptions: options } = await import(`data:text/javascript;base64,${Buffer.from(compiled).toString("base64")}`);
